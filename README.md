...
```sh
sudo apt-get install make gcc maven openjdk-8-jdk flex opam pkg-config libmpfr-dev autoconf libtool pandoc zlib1g-dev libxml2-utils
```

To run proofs, you will also need [Z3](https://github.com/Z3Prover/z3) prover. On Ubuntu, you can use `sudo apt install z3`
